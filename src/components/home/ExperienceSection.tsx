...
const pillars = [
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" aria-hidden="true">
        <path
          ...
          fill="none"
        />
        <path d="M14 7v7l4 4" stroke="#C68A4F" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    ),
  ...
  },
  {
    ...
    text: 'Producto de temporada, parrilla con carácter y elaboraciones que respetan el sabor. Sin artificios, con mucho cuidado.',
  },
  {
    id: 'momentos',
    icon: (
          ...
          <div>
            ...
            <Reveal delay={0.2}>
              ...
              <p className="section-subtitle max-w-md">
                En El Jardín creemos que comer bien es mucho más que alimentarse.
            ...
            <Reveal delay={0.3}>
              <p className="section-subtitle max-w-md mt-4">
                Un equipo apasionado cuida cada detalle: desde el primer saludo
                hasta el café final, pasando por una carta que cambia con las
                estaciones y una parrilla encendida con mimo artesanal.
              </p>
            </Reveal>
          </div>
